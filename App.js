...
import { Loading, Scene } from './components';
...
export default class App extends Component {
  ...
  renderLoading = text => <Loading text={text} />;

  render() {
    const { assetsLoaded, sceneLoaded } = this.state;
    if (!assetsLoaded) {
      return this.renderLoading('Loading Assets...');
    }
    return (
      <View style={styles.container}>
        ...
        />
        {!sceneLoaded && this.renderLoading('Loading Scene...')}
      </View>
    );
  }
}
